...
class CircleButton extends Button {
  ...
  update() {
    ...
    if (this.hitDetectCircle(player.p.x, player.p.y, 1, this.p.x, this.p.y, this.s.x)) {
      this.clicked = true;
      this.hovered = true;
    }
    super.update();
  ...
  draw() {
    ...
    var halo = 10 * sin(millis()/50);
    ellipse(this.p.x, this.p.y, this.s.x + halo, this.s.y + halo);
